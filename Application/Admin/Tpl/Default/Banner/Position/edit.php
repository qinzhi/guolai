                                    ...
                                    <div class="tab-pane active" id="tab-basic">
                                        <table class="table-form">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group has-feedback no-margin">
                                                        <input id="name" name="name" class="input-sm Lwidth400" type="text" value="{$position.name}" pattern="required" maxlength="50">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group has-feedback no-margin">
                                                        <input id="intro" name="intro" class="input-sm Lwidth400" value="{$position.intro}" type="text" maxlength="120">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <span class="control-group">
                                                            <div class="radio line-radio">
                                                                <label class="no-padding">
                                                                    <input name="status" type="radio" value="1" {$position['status'] == 1 ? 'checked' : ''}>
                                                                    <span class="text">开启</span>
                                                                </label>
                                                            </div>
                                                            <div class="radio line-radio">
                                                                <label>
                                                                    <input name="status" type="radio" value="0" {$position['status'] == 0 ? 'checked' : ''}>
                                                        ...
                                                        <div class="form-group has-feedback no-margin">
                                                            <div class="form-group no-margin">
                                                                <div class="input-group input-sm Lwidth400 no-padding">
                                                                    <input class="form-control" id="width" name="width" value="{$position.width}" pattern="required" type="text" maxlength="5">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group has-feedback no-margin">
                                                        <div class="form-group no-margin">
                                                            <div class="input-group input-sm Lwidth400 no-padding">
                                                                <input class="form-control" id="height" name="height" value="{$position.height}" pattern="required" type="text" maxlength="5">
                                                                <span class="input-group-addon">px</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="form-group has-feedback no-margin">
                                                        <div class="spinner spinner-right Lwidth400">
                                                            <input type="text" name="sort" class="spinner-input form-control" pattern="int" value="{$position.sort}">
