...
<head>
    ...
    <script type="text/javascript" src="__STATIC__/js/jquery.min.js"  media="all"></script>
    <script type="text/javascript" src="__JS__/jquery.websocket.js"  media="all"></script>
    <script type="text/javascript">
        WS_STATIC_URL = '__ADMIN__';
        WS_HOST = '127.0.0.1';
        WS_PORT = 843;
